...
void D3DApp::initMainWindow()
{
	...
	wc.lpszMenuName  = 0;
	wc.lpszClassName = (LPCWSTR)"D3DWndClassName";
	...
	mhMainWnd = CreateWindow((LPCWSTR)"D3DWndClassName", (LPCWSTR)mMainWndCaption.c_str(), 
...
bool D3DApp::isDeviceLost()
{
	...
	{
		MessageBox(0, (LPCWSTR)"Internal Driver Error...Exiting", 0, 0);
		PostQuitMessage(0);
		return true;
	}
